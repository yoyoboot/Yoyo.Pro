...
namespace Yoyo.Pro
{
    ...
    /// </summary>
    public class YoyoProWechatRegisterService : IRegisterService
    {
        private YoyoProWechatRegisterService(SenparcSetting senparcSetting)
        {
        ...
        public static IRegisterService Start(SenparcSetting senparcSetting, string contentRootPath = "")
        {
            ...
            var registerService = new YoyoProWechatRegisterService(senparcSetting);
