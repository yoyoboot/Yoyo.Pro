...
using Yoyo.Pro.ExternalAuth.FeiShu;
...
namespace Yoyo.Pro
{
    public static class ExternalAuthFeiShuExtensions
    {
        /// <summary>
        /// 添加基于 FeiShu 的身份认证服务
        /// </summary>
        ...
        /// <returns></returns>
        public static AuthenticationBuilder AddFeiShuProvider(this AuthenticationBuilder builder, string authenticationScheme, FeiShuProviderInfo providerInfo)
        {
            ...
            // 添加处理服务
            return builder.AddOAuth<FeiShuAuthenticationOptions, FeiShuAuthenticationHandler>(authenticationScheme, (options) =>
              {
