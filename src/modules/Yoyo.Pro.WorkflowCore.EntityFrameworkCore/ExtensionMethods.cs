...
namespace Yoyo.Pro.WorkflowCore.EntityFrameworkCore
{
    internal static class ExtensionMethods
    {
        ...
        internal static PersistedSubscription ToPersistable(this EventSubscription instance)
        {
            ...
            result.ExecutionPointerId = instance.ExecutionPointerId;
            result.WorkflowId = instance.WorkflowId;
            result.SubscribeAsOf = DateTime.SpecifyKind(instance.SubscribeAsOf, DateTimeKind.Local);
        ...
        internal static PersistedEvent ToPersistable(this Event instance)
        {
            ...
            result.EventKey = instance.EventKey;
            result.EventName = instance.EventName;
            result.EventTime = DateTime.SpecifyKind(instance.EventTime, DateTimeKind.Local);
        ...
        internal static WorkflowInstance ToWorkflowInstance(this PersistedWorkflow instance)
        {
            ...
            result.CreateTime = DateTime.SpecifyKind(instance.CreateTime, DateTimeKind.Local);
            if (instance.CompleteTime.HasValue)
                result.CompleteTime = DateTime.SpecifyKind(instance.CompleteTime.Value, DateTimeKind.Local);
            ...
            foreach (var ep in instance.ExecutionPointers)
            {
                ...
                if (ep.SleepUntil.HasValue)
                    pointer.SleepUntil = DateTime.SpecifyKind(ep.SleepUntil.Value, DateTimeKind.Local);
                ...
                if (ep.StartTime.HasValue)
                    pointer.StartTime = DateTime.SpecifyKind(ep.StartTime.Value, DateTimeKind.Local);

                if (ep.EndTime.HasValue)
                    pointer.EndTime = DateTime.SpecifyKind(ep.EndTime.Value, DateTimeKind.Local);
