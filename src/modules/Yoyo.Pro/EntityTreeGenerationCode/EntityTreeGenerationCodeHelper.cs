...
namespace Yoyo.Pro.EntityTreeGenerationCode
{
    ...
    /// 实体树菜单编码生成的帮助
    /// </summary>
    public class EntityTreeGenerationCodeHelper
    {
        ...
        public static string CreateCode(params int[] numbers)
        {
            ...
            return numbers.Select(number => number.ToString(new string('0', TreeGenerationCodeConst.CodeUnitLength))).JoinAsString(".");
        }
