...
**Package Manager**
```
Install-Package Yoyo.Pro.Alipay
```
**.NET CLI**
```
dotnet add package Yoyo.Pro.Alipay
```
**Paket CLI**
```
paket add Yoyo.Pro.Alipay
```
...
添加依赖 `typeof(YoyoProAlipayModule)` 到使用的 Module

示例:
``` cs

[DependsOn(
    typeof(YoyoProAlipayModule)
)]
