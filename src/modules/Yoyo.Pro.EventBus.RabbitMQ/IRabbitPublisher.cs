...
namespace Yoyo.Pro
{
    ...
    public class RabbitPublisher : IRabbitPublisher
    {
        ...
        protected readonly IRabbitSubscriber _rabbitSubscriber;
        public RabbitPublisher(IRabbitConnectionStore rabbitConnectionStore, IMsgPackSerializer msgPackSerializer, IRabbitSubscriber rabbitSubscriber)
        {
