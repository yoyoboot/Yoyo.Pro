...
{
    /// <summary>
    /// 支持SharedingCore的 DbContext 基类
    /// </summary>
    /// <typeparam name="TTenant"></typeparam>
    /// <typeparam name="TRole"></typeparam>
    /// <typeparam name="TUser"></typeparam>
    /// <typeparam name="TSelf"></typeparam>
    public abstract class YoyoProDbContextShardingCore<TTenant, TRole, TUser, TSelf>
        : YoyoProDbContext<TTenant, TRole, TUser, TSelf>,
        IShardingDbContext,
        ...
        where TSelf : YoyoProDbContextShardingCore<TTenant, TRole, TUser, TSelf>
    {
        private readonly IShardingDbContextExecutor _shardingDbContextExecutor;

        protected YoyoProDbContextShardingCore(DbContextOptions<TSelf> options)
            : base(options)
        {
            var wrapOptionsExtension = options.FindExtension<ShardingWrapOptionsExtension>();
            if (wrapOptionsExtension != null)
            {
                _shardingDbContextExecutor = (IShardingDbContextExecutor)Activator.CreateInstance(
