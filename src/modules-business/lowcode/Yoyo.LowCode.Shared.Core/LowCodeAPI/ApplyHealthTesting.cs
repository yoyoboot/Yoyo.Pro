...
namespace Yoyo.LowCode.LowCodeAPI
{
    ...
    /// API网关应用 连接健康安全检测
    /// </summary>
    public class ApplyHealthTesting : LowCodeFullAuditedEntity<Guid>
    {
        /// <summary>
        /// 网关应用ID
        /// </summary>
        ...
        /// <summary>
        /// 熔断模式 名称（无熔断 基础模式   高级模式 ）
        /// </summary>
        [MaxLength(200)]
        public string FusingModeName { get; set; }

        /// <summary>
        /// 熔断模式 Code（无熔断 基础模式   高级模式 ）
        /// </summary>
        [MaxLength(200)]
        ...
        /// <summary>
        /// 采样时间区间 类型名称 （小时H  分钟M  秒S）
        /// </summary>
        [MaxLength(50)]
        public string SITypeName { get; set; }

        /// <summary>
        /// 采样时间区间 类型Code （小时H  分钟M  秒S）
        /// </summary>
        [MaxLength(50)]
        ...
        /// <summary>
        /// 持续熔断时间 类型名称 （小时H  分钟M  秒S）
        /// </summary>
        [MaxLength(50)]
        public string CFTypeName { get; set; }

        /// <summary>
        /// 持续熔断时间 类型Code （小时H  分钟M  秒S）
        /// </summary>
        [MaxLength(50)]
