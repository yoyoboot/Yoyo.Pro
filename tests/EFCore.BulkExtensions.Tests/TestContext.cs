...
namespace EFCore.BulkExtensions.Tests
{
    public class TestContext : DbContext
    {
        ...
        public DbSet<Documentss> Documentss { get; set; }
    ...
    public class Product : Entity<Guid>
    {
        ...
        /// </summary>
        [Comment("工作流BaseId")]
        public Guid? WorkFlowBaseId { get; set; }
        ...
        /// </summary>
        [Comment("培训需求组Id")]
        public Guid? TrainingRequirementGroupId { get; set; }

        /// <summary>
        /// 物料的度量单位，关联UOM的GUID
        /// </summary>
        [Comment("物料的度量单位，关联UOM的GUID")]
        ...
        /// </summary>
        [Comment("流水号规则")]
        public Guid? NumberRuleId { get; set; }

        //[NotMapped]
        //public NumberingRule NumberRule { get; set; }
        ...
        /// </summary>
        [Comment("SN号置换规则")]
        public Guid? SNCodeRuleId { get; set; }
        ...
        /// </summary>
        [Comment("包装规则")]
        public Guid? PackageRuleId { get; set; }

        /// <summary>
        /// 包装规则Base
        /// </summary>
        [Comment("包装规则")]
        public Guid? PackageRuleBaseId { get; set; }

        public void SetBaseId(Guid baseId)
        {
            this.ProductBaseId = baseId;
        }
        ...
        /// </summary>
        [Comment("物料上下限Id")]
        public Guid? MaterialLimitId { get; set; }

        /// <summary>
        /// 配方BaseId
        /// </summary>
        [Comment("配方BaseId")]
        public Guid? RecipeBaseId { get; set; }
    ...
    public class Documentss : Entity<Guid>
    {
        /// <summary>
        /// 所属租户
        /// </summary>
        ...
        [Required]
        [Comment("文档Base")]
        public Guid DocumentBaseId { get; set; }
